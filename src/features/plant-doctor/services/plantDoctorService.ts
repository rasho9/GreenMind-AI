...
import type { PlantVisionClient, PlantVisionInput } from './integrationContracts';
...
/** Sends the validated plant image to the secure OpenAI Responses API route for live vision analysis. */
